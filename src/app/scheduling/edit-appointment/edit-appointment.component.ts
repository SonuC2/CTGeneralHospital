...
appointmentStatus:String="Rescheduled";
  ...
  rescheduleTime: string[] = ['10am - 11am', '10.30pm - 11pm', '3pm-4pm','9am - 10am', '12pm - 1pm'];
 
  
  onSubmit() {
    console.log(this.form.value);
    console.log(this.form.get('id')?.value);
    this.form.get("appointmentStatus")?.setValue("aOK");
    this.service.updateAppointment(this.form.value,this.appointmentId).subscribe();
